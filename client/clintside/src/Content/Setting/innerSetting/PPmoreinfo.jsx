      ...
      <div className='rightsetting'>
            ...
            <div className='profile2ndContainer'>
              <div className='profileinside'>
                <h1 className='h1fororofile'>Personal Information</h1>
                <div className='div1' style={{display:"flex",gap:"100px" ,justifyContent:"space-around",marginTop:"20px", marginBottom:"30px",fontSize:"20px"}}>
                <div style={{display:"flex"}}><lable style={{marginLeft:"-50px"}}>Male</lable><input style={{borderRadius:"10px" ,border:"1px solid black"}} type="radio"/></div> 
                <div style={{display:"flex"}}><lable style={{marginLeft:"-50px"}}>female</lable><input style={{borderRadius:"10px" ,border:"1px solid black"}} type="radio"/></div> 
                </div>
                <div className='div1'>
                ...
                <div className='div2'>
                <div><lable>Email</lable><input style={{borderRadius:"10px" ,border:"1px solid black"}} type="text"/></div>
                <div><lable>PhoneNo</lable><input style={{borderRadius:"10px" ,border:"1px solid black",marginLeft:"-19px"}} type="text" /></div>
                </div>
                <div className='div2'>
                <div><lable>Location</lable><input style={{borderRadius:"10px" ,border:"1px solid black"}} type="text"/></div>
                <div><lable>Postan No</lable><input style={{borderRadius:"10px" ,border:"1px solid black",marginLeft:"-19px"}} type="text" /></div>
                </div>
